...
actionEntry entries[] = {
    {"dodaj", ImVec2(0, 1.0), ImVec2(0.25, 0.75), empty}, {"usun", ImVec2(0.25, 1.0), ImVec2(0.5, 0.75), empty}, {"model", ImVec2(0.25, 0.75), ImVec2(0.5, 0.5), empty}, {"zdjecie", ImVec2(0.5, 0.75), ImVec2(0.75, 0.5), empty}, {"zaladuj", ImVec2(0.75, 0.75), ImVec2(1.0, 0.5), empty}, {"zrzut", ImVec2(0, 0.5), ImVec2(0.25, 0.25), empty},
};
