...
impl MyMiniquadApp {
    fn new() -> Self {
        ...
        gen_cube!(v3d, i3d, ic3d, vc3d, -20., -3., 65.5, 40., 6., 4.5, [0.2, 0.6, 0.3], [0.5, 0.4, 0.2]);
        gen_cube!(v3d, i3d, ic3d, vc3d, -20., -3., 61.,  35., 6., 4.5, [0.2, 0.6, 0.3], [0.5, 0.4, 0.2]);
        gen_cube!(v3d, i3d, ic3d, vc3d,  15., -3., 61.,  5., 6., 4.5, [0.5, 0.5, 0.6], [0.5, 0.5, 0.8]);

        gen_cube!(v3d, i3d, ic3d, vc3d, -20., -3., 52.,  40., 6., 9., [0.4, 0.8, 0.3], [0.2, 0.8, 0.5]);
        gen_cube!(v3d, i3d, ic3d, vc3d, -20., -3., 43.,  20., 6., 9., [1.0, 0.6, 0.5], [1.0, 0.4, 0.6]);
        gen_cube!(v3d, i3d, ic3d, vc3d,   0., -3., 43.,  20., 6., 9., [0.1, 0.3, 0.8], [0.4, 0.2, 0.8]);
